...
const handleEdit = () => {
    router.visit(route('leads.edit', props.leadId));
};

const handleDelete = async () => {
    try {
        await destroy(`/leads/${props.leadId}`);
                            ...
                            <div class="flex items-start justify-between">
                                <div>
                                    ...
                                    <div class="mt-2 flex items-center gap-2">
                                        <span :class="['inline-flex rounded-full px-3 py-1 text-sm font-semibold', getStatusColor(lead.status)]">
                                            {{ lead.status }}
                                        </span>
